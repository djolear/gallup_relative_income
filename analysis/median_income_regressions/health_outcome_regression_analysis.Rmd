...
lm2 <-
  lm(
    fruits_veggies_scale ~
      med_inc_demo_age_gallup_scale * raw_income_scale +
      med_inc_demo_age_gallup_scale * education_scale +
      med_inc_demo_age_gallup_scale * employment_all +
      med_inc_demo_age_gallup_scale * sex +
      med_inc_demo_age_gallup_scale * age_scale +
      med_inc_demo_age_gallup_scale * race +
      med_inc_demo_age_gallup_scale * married +
      med_inc_demo_age_gallup_scale * year +
      physicians_scale +
      unweighted_pop_county_scale +
      median_monthly_housing_cost_county_scale +
      land_area_2010_scale +
...
```{r}
plot_model(lm2, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "education_scale"))
plot_model(lm2, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "raw_income_scale"))
plot_model(lm2, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "age_scale"))
plot_model(lm2, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "sex"))
```
...
```{r}
plot_model(lm1, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "education_scale"))
plot_model(lm1, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "raw_income_scale"))
plot_model(lm1, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "age_scale"))
plot_model(lm1, type = "pred", terms = c("med_inc_demo_age_gallup_scale", "sex"))
```
