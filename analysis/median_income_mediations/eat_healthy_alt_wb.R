...
fv_mediation1_function <- function(current_year, dfg){
  ...
  model <- 
    '
    # direct effect
    fruits_veggies_scale ~ b1 * PURPOSE_scale + b2 * enough_money_scale + b3 * comp_satis_std_liv_scale + b4 * COMMUNITY_scale + b5 * SOCIAL_scale + c * median_income_demo_scale  + control2b * raw_income_scale + control3b * education_scale + control4b * median_monthly_housing_cost_county_scale + 
